#include "Wprowadz_nick.h"

Wprowadz_nick::Wprowadz_nick(float size, sf::Color color)
{
	text.setCharacterSize(size);
	text.setFillColor(color);
}

Wprowadz_nick::~Wprowadz_nick()
{
}

void Wprowadz_nick::draw(sf::RenderWindow& window)
{
	//window.clear();
...
void Wprowadz_nick::napisz_na(sf::Event input)
{
...
void Wprowadz_nick::setFont(sf::Font& font)
{
	text.setFont(font);
}

void Wprowadz_nick::setPosition(float width, float height)
{
	text.setPosition(sf::Vector2f(width, height));
}

void Wprowadz_nick::wejscie(int typZnaku)
{
...
void Wprowadz_nick::skasuj_znak()
{
