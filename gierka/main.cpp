...
int main()
{
	...
	while (gra.isOpen())
	{
		...
		{
			if (whichWeapon != 1) shotting.isFirstShot = true;
			whichWeapon = 1;
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num2))
		{
			if (whichWeapon != 2) shotting.isFirstShot = true;
			whichWeapon = 2;
		}
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Num3))
		{
			if (whichWeapon != 3) shotting.isFirstShot = true;
			whichWeapon = 3;
		}
		...
		if (whichWeapon == 1)
		{
			...
			enemySpawner.enemyCollision(shotting, m4a4.damage);
			...
			HUD.hudDisplay(gra, HUDx, HUDy, m4a4, m4a4.isLoaded, player1.hp, player1.hpMax, whichWeapon);
		}
		else if (whichWeapon == 2)
		{
			...
			HUD.hudDisplay(gra, HUDx, HUDy, shotgun, shotgun.isLoaded, player1.hp, player1.hpMax, whichWeapon);
		}
		else if (whichWeapon == 3)
		{
			...
			HUD.hudDisplay(gra, HUDx, HUDy, minigun, minigun.isLoaded, player1.hp, player1.hpMax, whichWeapon);
		}
